...
y′=y(2−x)+x+1,y(x0)=y0,
com x0=0.49238 e y0=2.57034. Use o 
método do ponto médio de Euler com tamanho do passo h=0.18435 para estimar o valor da solução exata
desse PVI nos pontos xk=x0+kh, para k=1,2,…,10.
'''
